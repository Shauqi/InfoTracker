...
public class ScienceNews extends JPanel
{
	
    MovieFeedParser parser = new MovieFeedParser("http://www.wired.com/category/science/feed/");
	...
	label.addMouseListener(new MouseAdapter() {
		public void mouseClicked(MouseEvent e)
		{
			...
			{
			  try {
				Desktop.getDesktop().browse(new URL("http://www.wired.com/category/science").toURI());
